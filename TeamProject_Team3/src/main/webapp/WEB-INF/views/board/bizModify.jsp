...
<table class="table table-bordered" table width="500" cellpadding="0" cellspacing="0" border="1">
	...
	<form action="bizModify" method="post" enctype="multipart/form-data">

		<tr>
			<td class="active col-md-2" align="center">이름</td>
			<td class="col-md-4">${ list.b_name }</td>
			<td class="active col-md-2">글번호</td>
			<td class="col-md-4">${ list.b_id }<input type="hidden" name="b_id" value="${ list.b_id }"></td>
		</tr>
		<tr>
			<td class="active" align="center">제목</td>
			<td colspan="3"><input type="text" name="b_title" size="50" required="required" value="${ list.b_title }" class="form-control"></td>

		</tr>
		<tr>
			<td class="active" align="center">내용</td>
			<td colspan="3"><textarea name="b_content" required="required" rows="10" class="form-control">${ list.b_content }</textarea></td>
