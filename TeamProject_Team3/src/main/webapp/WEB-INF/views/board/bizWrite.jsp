...
<table class="table table-bordered" table width="500" cellpadding="0" cellspacing="0" border="1">
	<form action="bizWrite" method="post" enctype="multipart/form-data">
		<tr>
			<td class="active" align="center">이름</td>
			<td><input type="text" name="b_name" required="required" size="50" class="form-control"></td>
		</tr>
		<tr>
			<td class="active" align="center">제목</td>
			<td><input type="text" name="b_title" required="required" size="50" class="form-control"></td>
		</tr>
		<tr>
			<td class="active" align="center" >내용</td>
			<td><textarea name="b_content" required="required" rows="10" class="form-control"></textarea></td>
		</tr>
		<tr>
