...
/* function winOpen2()
{
	...
	<form name="resignation_cancel" action="resignation_cancel_up" method="post" onSubmit="return checkId()">
			<h5 align="center"><font color="blue">[퇴사 취소 처리할 사원의 이름을 클릭해주세요]</font></h4>
	<div align="center">
	...
	<div align="center"><input type="submit" value="퇴사 취소"  class="btn btn-primary btn-sm" readonly="readonly" style="width: 90px;"/> <!-- onClick="winOpen2()" -->
